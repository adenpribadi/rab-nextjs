  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          <h1 style={{ fontSize: '1.75rem', fontWeight: 700, margin: '0 0 0.5rem 0' }}>Master Vendors / Suppliers</h1>
          <p style={{ color: 'var(--text-muted)', margin: 0, fontSize: '0.9rem' }}>
            Manage the material stores, vendors, and sub-contractors you work with.
          </p>
        </div>
        <Link href="/suppliers?add=true" className="btn-primary" style={{ textDecoration: 'none' }}>
          + Add Supplier
        </Link>
      </div>
            ...
            <tbody>
              {suppliers.map((supplier) => (
                <tr key={supplier.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <td style={{ padding: '1rem' }}>
                    {supplier.category ? (
                      <span style={{ padding: '0.2rem 0.5rem', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                        {supplier.category}
                      </span>
                    ) : '-'}
                  </td>
                  ...
                  <td style={{ padding: '1rem', textAlign: 'right' }}>
                    <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
                      <Link href={`/suppliers?edit=${supplier.id}`} style={{ color: 'var(--text-muted)', textDecoration: 'none' }} title="Edit">
