  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1 className="page-title" style={{ fontSize: '1.75rem' }}>Master Clients</h1>
              ...
              <tbody>
                {clients.map((client) => (
                  <tr key={client.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                    <td data-label="Client / Company" style={{ padding: '1rem' }}>
                    ...
                    <td data-label="Projects" style={{ padding: '1rem', textAlign: 'center' }}>
                    ...
                    <td data-label="Actions" style={{ padding: '1rem', textAlign: 'right' }}>
                      <div className="table-actions-mobile" style={{ display: 'flex', gap: '0.75rem', justifyContent: 'flex-end' }}>
                        <Link href={`/clients?edit=${client.id}`} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: 'var(--text-muted)', textDecoration: 'none', background: 'var(--bg-tertiary)', padding: '0.4rem 0.75rem', borderRadius: '4px', border: '1px solid var(--border-color)' }} title="Edit">
                          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                          </svg>
                          <span className="mobile-only-text" style={{ display: 'none' }}>Edit Client</span>
                        </Link>
