      ...
      <header className="page-header">
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', margin: 0, fontSize: '0.95rem' }}>
            Update the project details below. Cost items are managed on the project details page.
          </p>
        </div>
      </header>

      <form action={updateProject} className="responsive-form-layout">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1rem' }}>
              ...
              <div className="responsive-grid" style={{ gap: '1rem' }}>
                <div>
                  ...
                  {clients.length > 0 ? (
                    <select name="clientId" className="input-field" defaultValue={project.clientId || ''}>
                  ...
                  {clients.length > 0 && <input type="hidden" name="clientName" value={project.clientName || ''} />}
                </div>
                <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div className="glass-card" style={{ padding: '1.25rem' }}>
            ...
            <div>
              <label className="input-label" style={{ fontWeight: 600 }}>Current Status</label>
              <select name="status" defaultValue={project.status} className="input-field" style={{ appearance: 'none', cursor: 'pointer' }}>
